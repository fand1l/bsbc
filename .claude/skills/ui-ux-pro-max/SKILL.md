...
The search script lives inside this skill's own directory. Invoke it by the path below from the repository root (or use the absolute path to the skill directory if the working directory differs):
